我的日常工作经常需要中英混排工具来对文本内容进行格式化处理，之前常用的是在线的[独特工具箱](https://www.dute.org/type-setting)。不过前段时间，该工具曾短暂不可用，于是让 AI 复刻了一个可以离线使用的版本，并且没有冗余的说明文本，我也将其部署到了这里：<https://www.czyouge.xyz/tools/typesetting/>
